...
import PostCardStaff from '../components/PostCardStaff';

import { useNavigate } from 'react-router-dom';
export default function PostStaff() {
    ...
    return (
        <Container sx={{ mt: 4 , mb: 4}}>
            ...
            <Button variant="contained" color="primary" onClick={() => navigate('/staff/create-post')} sx={{ mt: 4, mb: 4 }}>
                Create New Post
            </Button>
            {loading ? (
                <CircularProgress />
